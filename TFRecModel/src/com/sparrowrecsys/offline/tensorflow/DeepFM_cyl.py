...
def DeepFM(drop_rate=0.2):
    ...
    deep_feature_columns = [tf.feature_column.numeric_column('sour'),
                            ...
                            tf.feature_column.numeric_column('sum_invite_user_cnt_his'),
                            tf.feature_column.numeric_column('sum_invite_valid_deal_user_cnt_his'),
                            tf.feature_column.numeric_column('sum_valid_deal_ord_cnt_his'),
                            tf.feature_column.numeric_column('sum_valid_deal_pin_ord_cnt_his'),
                            tf.feature_column.numeric_column('sum_valid_deal_zd_ord_cnt_his'),
                            tf.feature_column.numeric_column('sum_valid_deal_amt_7d'),
                            tf.feature_column.numeric_column('sum_valid_deal_amt_30d'),
                            tf.feature_column.numeric_column('sum_valid_deal_amt_his'),
                            tf.feature_column.numeric_column('sum_valid_deal_sku_cnt_7d'),
                            tf.feature_column.numeric_column('sum_valid_deal_sku_cnt_30d'),
                            tf.feature_column.numeric_column('sum_valid_deal_sku_cnt_his'),
                            tf.feature_column.numeric_column('sum_valid_deal_days_7d'),
                            tf.feature_column.numeric_column('sum_valid_deal_days_30d'),
                            tf.feature_column.numeric_column('sum_valid_deal_days_his'),
                            tf.feature_column.numeric_column('sum_valid_deal_ord_cnt_7d'),
                            tf.feature_column.numeric_column('sum_valid_deal_ord_cnt_30d'),
                            spu_emb_col,
                            user_emb_col]
